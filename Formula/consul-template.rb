class ConsulTemplate < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{self.class.mirror}/consul-template/#{version}/consul-template_#{version}_darwin_amd64.zip"
    sha256 "a7cacd136ddc36d1453a1efc84992526ca9d65d909270478ee7175f96e876be0"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{self.class.mirror}/consul-template/#{version}/consul-template_#{version}_darwin_arm64.zip"
    sha256 "c35c89e84d3b6ecf99a13c61267ecc259077ea24f8d498861695e8c4b4048c16"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{self.class.mirror}/consul-template/#{version}/consul-template_#{version}_linux_amd64.zip"
    sha256 "aa49f009a708f3e3beea990aa29cfaecfe6925c0b17ca9201747e1469922264e"
  end

  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    url "#{self.class.mirror}/consul-template/#{version}/consul-template_#{version}_linux_arm.zip"
    sha256 "37bfba774c059116553dd38f1daa0bc521747a9a00ca42e0cc279afed2304f67"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{self.class.mirror}/consul-template/#{version}/consul-template_#{version}_linux_arm64.zip"
