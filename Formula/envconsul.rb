class Envconsul < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{mirror}/envconsul/#{version}/envconsul_#{version}_darwin_amd64.zip"
    sha256 "068c5f0850ce8a29ab1e37a02d79e5d8317bcdf1e1e8dd8de38f7f62061a18d5"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{mirror}/envconsul/#{version}/envconsul_#{version}_darwin_arm64.zip"
    sha256 "5351b1230860f6e2f6398d49836ea2a7245dcbcc3eee51125c523107d5b5ef39"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{mirror}/envconsul/#{version}/envconsul_#{version}_linux_amd64.zip"
    sha256 "d7b1d4395ce9b465b6e635c9bd8ec70b852de5553fa0b9ecd07829323cf9ead1"
  end

  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    url "#{mirror}/envconsul/#{version}/envconsul_#{version}_linux_arm.zip"
    sha256 "3812da750ff2e63293326c46b04f778a901f0ca6971645428eae052b505b0f97"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{mirror}/envconsul/#{version}/envconsul_#{version}_linux_arm64.zip"
