class TerraformLs < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{self.class.mirror}/terraform-ls/#{version}/terraform-ls_#{version}_darwin_amd64.zip"
    sha256 "cc5bbc5b5a39d12d455c0d2b1e4b3a2c1f237d02d2cf819cf5252358f2d674de"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{self.class.mirror}/terraform-ls/#{version}/terraform-ls_#{version}_darwin_arm64.zip"
    sha256 "6f80fe0b34af184175508f3d9135d8159f5dce4000d9b39540553eb1c267c54b"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{self.class.mirror}/terraform-ls/#{version}/terraform-ls_#{version}_linux_amd64.zip"
    sha256 "7750edc736845fd8c04ff0fc6332423c12d8275b358668c8c17e8aedc43ef971"
  end

  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    url "#{self.class.mirror}/terraform-ls/#{version}/terraform-ls_#{version}_linux_arm.zip"
    sha256 "cfb11bb8c23801def22f06091330b1ec72b7df567971fd997e8aa656b3105f20"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{self.class.mirror}/terraform-ls/#{version}/terraform-ls_#{version}_linux_arm64.zip"
