...
class Levant < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{HashicorpMirror.url}/levant/#{version}/levant_#{version}_darwin_amd64.zip"
    sha256 "5c82f04a8c229b0a6a212b110229be0917595ab3be9b89cdcb7f7da8c667a789"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{HashicorpMirror.url}/levant/#{version}/levant_#{version}_darwin_arm64.zip"
    sha256 "50bc8792f672042e3c23a70b994d2c2075fe8b5c3f9ae0cb5caf55e4c6c4559e"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{HashicorpMirror.url}/levant/#{version}/levant_#{version}_linux_amd64.zip"
    sha256 "44ff68a3f25b15aded1da2b7bae6ddbcdac09e4517d526d69ed79180bc4240ed"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{HashicorpMirror.url}/levant/#{version}/levant_#{version}_linux_arm64.zip"
