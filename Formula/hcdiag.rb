class Hcdiag < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{self.class.mirror}/hcdiag/#{version}/hcdiag_#{version}_darwin_amd64.zip"
    sha256 "28f58db0239b4d4ff2259f2591b9e461410522e0a5963ab9b747ef8023f41495"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{self.class.mirror}/hcdiag/#{version}/hcdiag_#{version}_darwin_arm64.zip"
    sha256 "81e18ed8937e5e5ec8b5d6e02d30089ac1ef7498ea8854482220aa7f50f54b4f"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{self.class.mirror}/hcdiag/#{version}/hcdiag_#{version}_linux_amd64.zip"
    sha256 "856c86e3f208775ea8982aa76754fd38f192762541225aa3fc127fd19743bb8a"
  end

  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    url "#{self.class.mirror}/hcdiag/#{version}/hcdiag_#{version}_linux_arm.zip"
    sha256 "848ddc1a6bd6882f96042038a9822068a82256fc2111ffab43f329de4a5aad26"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{self.class.mirror}/hcdiag/#{version}/hcdiag_#{version}_linux_arm64.zip"
