class NomadPack < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{mirror}/nomad-pack/#{version}/nomad-pack_#{version}_darwin_amd64.zip"
    sha256 "c8a77d76b22c11474b546e1496ca50e544ea3dd2a3b5568e56694c91388040f8"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{mirror}/nomad-pack/#{version}/nomad-pack_#{version}_darwin_arm64.zip"
    sha256 "f79be784281fecc64fa0af4a93bda487b0d1ee152d0dad635b93ce98e77522d7"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{mirror}/nomad-pack/#{version}/nomad-pack_#{version}_linux_amd64.zip"
    sha256 "58399149a2b3944d17294fb5c98b30cd02fc9fd1f8d5275713be3dbc5345bfb4"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{mirror}/nomad-pack/#{version}/nomad-pack_#{version}_linux_arm64.zip"
