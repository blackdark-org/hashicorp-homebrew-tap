...
class Hcp < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{HashicorpMirror.url}/hcp/#{version}/hcp_#{version}_darwin_amd64.zip"
    sha256 "5dc1d68c848eebf33a8897885f51ba243b82abe2f5db6546b404729b7bfbe6a4"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{HashicorpMirror.url}/hcp/#{version}/hcp_#{version}_darwin_arm64.zip"
    sha256 "064fb59443d437d71a532ae054ba888fe993ce34164cb858c54ea416226a2417"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{HashicorpMirror.url}/hcp/#{version}/hcp_#{version}_linux_amd64.zip"
    sha256 "09a0d2bd8a8834907e162188c4d68468824444aca163b28b8c38ba63749fb052"
  end

  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    url "#{HashicorpMirror.url}/hcp/#{version}/hcp_#{version}_linux_arm.zip"
    sha256 "15f8eae1b4abc91f4a03380b583503304cd16e5cad468845c34c1eb67766daa3"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{HashicorpMirror.url}/hcp/#{version}/hcp_#{version}_linux_arm64.zip"
