class VaultRadar < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{mirror}/vault-radar/#{version}/vault-radar_#{version}_darwin_amd64.zip"
    sha256 "f732c0eebe20151004311910ab767e6947037b82d3ed0f93a0789693d9f8012f"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{mirror}/vault-radar/#{version}/vault-radar_#{version}_darwin_arm64.zip"
    sha256 "8364000f50f6d275f8f658931d3203764711beaf86ece608f1e31d88edc48a40"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{mirror}/vault-radar/#{version}/vault-radar_#{version}_linux_amd64.zip"
    sha256 "e89a9764fcb687fff627b34c13d5b2295c2bc899e945d15c203c81e58c6c5055"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{mirror}/vault-radar/#{version}/vault-radar_#{version}_linux_arm64.zip"
