class Packer < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "#{self.class.mirror}/packer/#{version}/packer_#{version}_darwin_amd64.zip"
    sha256 "64c4aa9a3176f89496360843bc8747238c9ad32ddc68bc5281207ae342d45be9"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "#{self.class.mirror}/packer/#{version}/packer_#{version}_darwin_arm64.zip"
    sha256 "6530042cf8f8a1f96b6607cb22b5be298be53b400cd4a2c81ab8b946964fccda"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "#{self.class.mirror}/packer/#{version}/packer_#{version}_linux_amd64.zip"
    sha256 "5edcd14ab59b535040c512dbecd6ec9ef976a000b073c19d93e4c431c948581e"
  end

  if OS.linux? && Hardware::CPU.arm? && !Hardware::CPU.is_64_bit?
    url "#{self.class.mirror}/packer/#{version}/packer_#{version}_linux_arm.zip"
    sha256 "ea4f55fe0a2b38d57c8261d7a0999b17d4fcea03306b7781f52d09d99de26347"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "#{self.class.mirror}/packer/#{version}/packer_#{version}_linux_arm64.zip"
